...
class TabFieldFilterRepository {
  ...
  def getFilter(smpl_id: String, user_id: Int): Future[Seq[(Int, Int, Int, Option[List[String]], String, Int, Option[List[String]], String, Option[String], Option[Boolean], Option[String], Option[String])]] = {
    val query = for {
